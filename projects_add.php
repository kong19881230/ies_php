				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-bordered">
							<div class="box-title">
								<h3>
									<i class="fa fa-th-list"></i>新增項目設備保養資料</h3>
							</div>
							<div class="box-content nopadding">
								...
								<form action="?page=projects_add" method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered'>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="con_start_date" id="textfield" placeholder="2010-05-06" class="form-control datepick" value='<?php echo $finalcon_start_date; ?>'>
										</div>
									</div>
									<div class="form-group">
										<label for="textfield" class="control-label col-sm-2">合約結束日期</label>
										<div class="col-sm-10">
											<input type="text" name="con_espr_date" id="textfield" placeholder="2014-05-06" class="form-control datepick" value='<?php echo $finalcon_espr_date; ?>'>
										</div>
									</div>
