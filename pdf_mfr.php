						...
						<div class="box">
							...
							<div class="box-content nopadding"> 
								<table class="table table-hover table-nomargin dataTable dataTable-tools table-bordered dataTable-colvis  " width="850" style="font-size:12px;">
									<thead>
										<tr>
											<th colspan="2" style="text-align: center"  ><?php echo $reports_cycles_cn[$reports_list[0]['cycle_type']]; ?>服務<br><?php echo $reports_cycles_en[$reports_list[0]['cycle_type']]; ?> Service</th>
											 
											<th colspan="2" style="text-align: center" width='160'><?php echo $maintain_froms_list[0]['device_id'].'<br>'.$maintain_froms_list[0]['device_model']; ?></th>
