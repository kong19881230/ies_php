...
class Sdba
{
    ...
    public static function table($table = '', $params = false)
    {
        ...
        include_once ('sdba/sdba_config.php');
        ...
        {
            $dbuser = Sdba_config::$dbuser;
            $dbpass = Sdba_config::$dbpass;
            $dbname = Sdba_config::$dbname;
            $dbhost = Sdba_config::$dbhost;
            $dbencoding = Sdba_config::$dbencoding;
        }
    ...
    private function __construct($table, $dbuser, $dbpass, $dbname, $dbhost, $dbencoding)
    {
        ...
        if ($table)
            $this->table = $table;
        $this->autoreset = Sdba_config::$autoreset;
    }
    ...
    public function update_fk($left_key_name = '', $left_key = '', $right_key_name = '', $right_key = '', $table = false, $fields =
        array())
    {
    ...
    public function group_concat($field = '', $alias = '', $separator = ',', $table = false, $distinct = true, $order_by = false,
        $direct = 'ASC')
    {
        if ($field)
        {
