...
if(isset($_POST['report'])) {
    ...
    //$report->customer_id
    $report_data = array('name_cn'=>$report->name_cn,'name_en'=>$report->name_en,'type'=>(int)$report->type,'project_id'=>(int)$report->project_id,
    ...
    $detail_data=array('report_id'=>$report->id,'problem_reported'=>$details->problem_reported,'is_system_down'=>$details->is_system_down,
      ...
      'status_after_service'=>$details->status_after_service,'remarks'=>json_encode($details->remarks),'contact_name'=>$details->contact_name,'designation'=>$details->designation,
      'phone'=>$details->phone,'fax'=>$details->fax,'email'=>$details->email,'reported_at'=>date("Y-m-d H:i:s", strtotime($details->reported_at)),'end_service_at'=>date("Y-m-d H:i:s", strtotime($details->end_service_at)),'start_service_at'=>date("Y-m-d H:i:s", strtotime($details->start_service_at)));
