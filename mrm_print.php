...
<td width="40%" style="text-align: right;"><span style="font-weight: bold;"> </span></td>
		...
		<table width="850" border="0" cellpadding="0" cellspacing="0"  >
			<tr>
                <td colspan="4" style="font-size: 26px; font-weight: bold; text-align: center; line-height: 44px;"><h1 style="line-height: 26px;font-size: 26px; "><?php  $type=$maintain_froms_list[0]['from_type']; echo $from_type_en[$type].' System ('.$from_type[$type].'系統)'; ?> - Remark</h1></td>
          </tr>
</table>
				<div class="row">
					<div class="col-sm-12">
