 		...
 		imgPicker: function(options) {
	    	...
	    	, html5Upload = function(button) {
				...
				if (file.type.match(imageType) && file.type != 'image/bmp') {
					...
					alertMessage('不能支援此格式 / Filetype not allowed', 2);
	    	}
